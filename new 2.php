...
<!--develop the gui in html-->
<div  class="tab-pane fade in active">

             <div class="signup-form">
                <form enctype="multipart/form-data" action="image_to_text.php" method="post">
              
                  <h2>IMAGE TO TEXT</h2>
                    <p class="hint-text">Upload your image files here.</p>
   

         <div class="form-group">
            <div class="row">
                <label class="col-xs-6">enter image file to be uploaded. </label>
        ...
        <div class="form-group">
         ...
         <?php
               if($msg=isset($_GET['msg']))
               {
           		 ...
           		 echo "<a href=". $_GET['msg'].">Download</a>";
