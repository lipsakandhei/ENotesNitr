...
<body>
    ...
    <div class="row">
        <div class="col-sm-8"><?php echo $sub_name;?>
             <div class="row">
        <div class="col-sm-6" style="background-color:violet;"><?php echo "subject: ".$sub_code;?></div>
        <div class="col-sm-6" style="background-color:lightgray;"><?php echo "author: ".$author_name;?></div>
        <div class="col-sm-6" style="background-color:violet;"><?php echo "profesor: ".$proff_name;?></div>
